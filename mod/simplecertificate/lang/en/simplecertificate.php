...
$string['modulename'] = 'Alleb2b Simple Certificate';
$string['modulenameplural'] = 'Alleb2b  Simple Certificates';
$string['pluginname'] = 'Alleb2b Simple Certificate';
...
$string['modulename_help'] = 'The simple certificate activity module enables the teacher to create a custom certificate that can be issued to participants who have completed the teacher’s specified requirements. <br> This plugin was modified by Alleb2b.';
